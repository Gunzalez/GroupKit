...
if(isset($_POST['colour'])){
    $_SESSION["front-font-colour"] = $_POST['colour'];
}
...
$colour = $_SESSION['back-font-colour'];
$size = $_SESSION['size'];
$nameStyle = $_SESSION['numberStyle'];
...
<body class="page inner garment-selection">
    ...
    <div class="main">
        <div class="content">
            ...
            <form class="form" id="ringleaders-front-form" action="ringleaders-add-order-new.php" method="post" name="ringleaders-front-form" novalidate="novalidate">
                ...
                <div class="row">
                    <label for="front-text">Personalise number</label>
