    ...
    <div class="main">
        <div class="content">
            ...
            <div class="showcase">
                ...
                <div class="details">
                    <h3>Choose a personalisation to set its options</h3>
            ...
            <form class="form" id="ringleaders-front-form" action="ringleaders-back.php" method="post" name="ringleaders-front-form" novalidate="novalidate">
