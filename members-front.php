...
<body class="choose-garment page">
    ...
    <div class="main">
        <div class="content">
            ...
            $_SESSION["colour"] = $gender = $_POST['colour'];
            $_SESSION["size"] = $gender = $_POST['size'];
            ...
            <div class="showcase">
                <div id="garment-display" class="display front <?php echo $gender; ?>">
                    <span class="figure small <?php echo $position; ?>" style="color: <?php echo $colour; ?>; font-family: '<?php echo $style; ?>';">
                        XXXX
                    </span>
                </div>
            </div>
            ...
            <form class="form" id="choose-garment-form" action="" method="post" name="choose-garment-form" novalidate="novalidate">
                ...
                <div class="row">
                    <div class="like-label">Style</div>
                    <div class="like-input style-switch block">
                        <input id="style4" type="radio" name="style" value="signikabold"<?php echoIfEqual('signikabold', $style, ' checked'); ?>>
                        <label for="style4">Signika Bold</label><br />
                        <input id="style1" type="radio" name="style" value="Verdana"<?php echoIfEqual('Verdana', $style, ' checked'); ?>>
                        <label for="style1">Verdana</label><br />
                        <input id="style2" type="radio" name="style" value="Arial"<?php echoIfEqual('Arial', $style, ' checked'); ?>>
                        <label for="style2">Some-long FontName</label><br />
                        <input id="style3" type="radio" name="style" value="Century Gothic"<?php echoIfEqual('Century Gothic', $style, ' checked'); ?>>
                ...
                <div class="row">
                    ...
                    <div class="like-input">
                        ...
                        <p>This is the name your Ringleader has chosen for you.</p>
                    </div>
                </div>
